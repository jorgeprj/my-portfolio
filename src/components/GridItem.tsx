...
const variants = cva(
	"shadow-grid rounded-3xl bg-neutral-50 dark:bg-neutral-900 flex flex-col justify-center @container",
	{
		variants: {
			size: {
		...
		<motion.div
			...
			className={cn(
				variants({
					size,
					className:
						"hover:dark:bg-neutral-800 hover:bg-neutral-100 duration-75 transition-colors ease-in-out",
				})
			)}
		>
			{children}
